<x-layout>
    ...
    <div class="px-4 py-5 my-5 text-center">
        ...
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">Nuestra plataforma es una solución innovadora que agiliza la emisión y validación de certificados
                en la Universidad Nacional Experimental de Guayana (UNEG),
                simplificando la acreditación de actividades académicas y comunitarias.</p>
        </div>
